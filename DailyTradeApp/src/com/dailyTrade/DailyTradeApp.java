...
public class DailyTradeApp {
    ...
    public static void main(String[] args) throws TradingException, IOException, ParseException {
        ...
        buySellJavaApplication.readData(arrayList);        
     ...
     */
    private ArrayList readData(ArrayList aList) throws IOException, ParseException {
    ...
    private void calcIncoming(ArrayList aList) {
        ...
        for (int i=0; i<aList.size(); i++) {
            ...
            if (buySell.getBuyOrSell().equalsIgnoreCase(Constants.SELL)) {                
                updateIncominglSummary(treeMap, buySell);
                updateOutgoingSummary(hashMap, buySell);
            } 
        }        
        printSummary(treeMap, hashMap, "SETTLED INCOMINGS DATA", "RANKING OF INCOMING DATA DETAILS");
    }
    ...
    private void calcOutgoings(ArrayList aList) {
        ...
        printSummary(treeMap, hashMap, "SETTLED OUTGOING DATA", "RANKING OF OUTGOING DATA DETAILS");
    }
    ...
    private TreeMap updateIncominglSummary(TreeMap treeMap, BuySell buySell) {
    ...
    private HashMap updateOutgoingSummary(HashMap hashMap, BuySell buySell) {
        Calculation cal  = new Calculation();
    ...
    private void printSummary(TreeMap treeMap, HashMap hashMap, String summaryTest, String entityText) {
        ...
        sortedHashMap = sortMapByValues(hashMap);        
    ...
    private HashMap sortMapByValues(HashMap map) { 
